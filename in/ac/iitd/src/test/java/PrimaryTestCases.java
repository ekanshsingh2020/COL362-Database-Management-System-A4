...
public class PrimaryTestCases {
    ...
    public List<Object []> eval(RelNode relNode, MyCalciteConnection calciteConnection) {
        try{
            ...
            System.out.println("===================================");
            System.out.println(phyRelNode);
            System.out.println("===================================");
            // System.out.println(phyRelNode.getVariablesSet());
    ...
    void writeResultToFile(List<Object []> result, String filename) {
        try{
    ...
    public void testSFW() {
        try{
            ...
            writeResultToFile(result, "testSFW.txt");
        ...
        System.out.println();
        System.out.println();
        System.out.println("Done with Filter and Project");
        System.out.println();
        System.out.println();
        System.out.println();
        return;
    ...
    public void testJoinAggregate_1() {
        try{
            MyCalciteConnection calciteConnection = new MyCalciteConnection();
            String query = "SELECT COUNT(*) FROM (SELECT rental.rental_id, rental.rental_date, payment.amount FROM rental JOIN payment ON rental.actor_id = payment.actor_id)";
    //         // String query = "SELECT * FROM temp FULL OUTER JOIN temp2 ON temp.actor_id = temp2.actor_id AND temp.customer_id = temp2.customer_id AND temp.staff_id = temp2.staff_id"; 

            // String query = "SELECT * FROM actor,payment LIMIT 20";

            // String query = "SELECT * FROM rental JOIN payment ON rental.actor_id = payment.actor_id";
    //         // String query = "SELECT * FROM rental JOI payment";
    //         // String query = "SELECT first_name, COUNT(first_name) , last_name FROM tempactor GROUP BY first_name, last_name";
    //         // String query = "SELECT first_name,COUNT(first_name) FROM actor GROUP BY first_name";
            RelNode relNode = createRelNode(query, calciteConnection);
            List<Object []> result = eval(relNode, calciteConnection);
            // result = new ArrayList<>();
            writeResultToFile(result,"testJoinAggregate_1.txt");
            System.out.println(result.size());
        ...
        System.out.println();
        System.out.println();
        System.out.println("Done with Join and Aggregate");
        System.out.println();
        System.out.println();
        System.out.println();
        return;
    ...
    public void testJoinAggregateSort_1() {
        try{
            ...
            // String query = "select film_id, count(film_id) as cnt \n"
            // + "from temprental r join tempinventory i\n"
            // + "on r.inventory_id = i.inventory_id group by film_id order by cnt DESC\n";


            RelNode relNode = createRelNode(query, calciteConnection);
            List<Object []> result = eval(relNode, calciteConnection);
            System.out.println(result.size());
            writeResultToFile(result,"JoinAggregateSort_1.txt");
        ...
        System.out.println();
        System.out.println();
        System.out.println("Done with Join and Aggregate and Sort");
        System.out.println();
        System.out.println();
        System.out.println();
        return;
    ...
    public void testSort(){
        try{
            ...
            // String query = "select title, length from film,rental where rating = 'PG' LIMIT 10";
            // String query = "select f.title from\n"
            //     + "(select title, length from film)\n"
            //     + "as f where f.length < 50 order by f.title ASC, f.length DESC";
            RelNode relNode = createRelNode(query, calciteConnection);
            List<Object []> result = eval(relNode, calciteConnection);
            System.out.println(result.size());


            writeResultToFile(result, "testSort.txt");
    ...
    public void testBonus(){
        try{
            MyCalciteConnection calciteConnection = new MyCalciteConnection();
            String query = "select last_name,first_name from actor order by first_name, last_name, actor_id";
    ...
    public void query1(){
        try{
            ...
            writeResultToFile(result, "query1.txt");
    ...
    //     try{
    //         MyCalciteConnection calciteConnection = new MyCalciteConnection();
    //         String query = "SELECT rental.rental, rental.rental_date, payment.amount FROM rental JOIN payment ON rental.rental_id = payment.rental_id";
    ...
    //         writeResultToFile(result, "query2.txt");
    ...
    public void query3(){
        try{
            ...
            writeResultToFile(result, "query3.txt");
    ...
    public void query4(){
        try{
            MyCalciteConnection calciteConnection = new MyCalciteConnection();
            String query = "SELECT title,name FROM film, film_category, category WHERE film.film_id = film_category.film_id AND film_category.category_id = category.category_id AND name = 'Action'";
            ...
            writeResultToFile(result, "query4.txt");
    ...
    public void query5(){
        try{
            MyCalciteConnection calciteConnection = new MyCalciteConnection();
            String query = "SELECT customer.customer_id, customer.first_name, customer.last_name, rental.rental_id, rental.rental_date FROM customer LEFT JOIN rental ON customer.customer_id = rental.customer_id";
            ...
            writeResultToFile(result, "query5.txt");
    ...
    public void query6(){
        try{
            ...
            writeResultToFile(result, "query6.txt");
    ...
    public void query7(){
        try{
            MyCalciteConnection calciteConnection = new MyCalciteConnection();
            String query = "SELECT film_id, count(film_id) FROM rental r JOIN inventory i ON r.inventory_id = i.inventory_id GROUP BY film_id ORDER BY film_id";
            ...
            writeResultToFile(result, "query7.txt");
    ...
    public void query8(){
        try{
            MyCalciteConnection calciteConnection = new MyCalciteConnection();
            String query = "SELECT category.name, COUNT(category.category_id) AS film_count FROM category LEFT JOIN film_category ON category.category_id = film_category.category_id GROUP BY category.name";
            ...
            writeResultToFile(result, "query8.txt");
    ...
    public void query9(){
        try{
            MyCalciteConnection calciteConnection = new MyCalciteConnection();
            String query = "SELECT category.name, COUNT(category.category_id) AS film_count FROM category, film_category, film WHERE category.category_id = film_category.category_id AND film_category.film_id = film.film_id GROUP BY category.name";
            ...
            writeResultToFile(result, "query9.txt");
    ...
    public void query10(){
        try{
            MyCalciteConnection calciteConnection = new MyCalciteConnection();
            String query = "SELECT category.name, AVG(film.rental_duration) AS average_rental_duration FROM category JOIN film_category ON category.category_id = film_category.category_id JOIN film ON film_category.film_id = film.film_id GROUP BY category.name";
            ...
            writeResultToFile(result, "query10.txt");
    ...
    public void query11(){
        try{
            MyCalciteConnection calciteConnection = new MyCalciteConnection();
            String query = "SELECT a.actor_id, a.first_name , a.last_name, COUNT(*) movie_count FROM actor a JOIN film_actor fa ON a.actor_id=fa.actor_id GROUP BY a.actor_id, a.first_name, a.last_name ORDER BY COUNT(*) DESC";
            ...
            writeResultToFile(result, "query11.txt");
...
// CHECK FOR HAVING WORKING
    ...
    public void query12(){
        try{
            ...
            writeResultToFile(result, "query12.txt");
...
// CHECK FOR DISTINT WORKING AND NOT EQUAL SYMBOL
// issue of same table opening twice
    @Test
    public void query13(){
        try{
            MyCalciteConnection calciteConnection = new MyCalciteConnection();
            String query = "SELECT DISTINCT a1.first_name, a2.last_name  FROM actor a1 JOIN actor a2 ON a1.first_name = a2.first_name AND a1.last_name = a2.last_name ORDER BY a1.first_name, a2.last_name DESC LIMIT 30";
            RelNode relNode = createRelNode(query, calciteConnection);
            System.out.println(RelOptUtil.toString(relNode));
            List<Object []> result = eval(relNode, calciteConnection);
            System.out.println(result.size());

            writeResultToFile(result, "query13.txt");
...
// CONCAT DOES NOT WORK
    ...
    //     try{
    //         MyCalciteConnection calciteConnection = new MyCalciteConnection();
    //         String query = "SELECT customer.customer_id, concat(customer.first_name, ' ', customer.last_name) as customer_name, COUNT(rental.actor_id) AS rental_count FROM customer JOIN rental ON customer.customer_id = rental.customer_id GROUP BY customer.customer_id ORDER BY rental_count DESC LIMIT 5";
    ...
    //         writeResultToFile(result, "query14.txt");
...
// CHECK DISTINCT WORKING AND ALSO NULL CHECK
// issue of same table opening twice
    ...
    public void query15(){
        try{
            MyCalciteConnection calciteConnection = new MyCalciteConnection();
            // String query = "SELECT DISTINCT film.title FROM film LEFT JOIN inventory ON film.film_id = inventory.film_id LIMIT 10";
            // String query = "SELECT film.title FROM film LEFT JOIN inventory ON film.film_id = inventory.film_id LEFT JOIN rental ON inventory.inventory_id = rental.inventory_id LIMIT 10";
            String query = "SELECT DISTINCT film.title FROM film LEFT JOIN inventory ON film.film_id = inventory.film_id LEFT JOIN rental ON inventory.inventory_id = rental.inventory_id WHERE rental.return_date IS NOT NULL LIMIT 10";
            ...
            writeResultToFile(result, "query15.txt");
    ...
    public void query16(){
        try{
            MyCalciteConnection calciteConnection = new MyCalciteConnection();
            String query = "SELECT DISTINCT inventory_id FROM rental";
            ...
            writeResultToFile(result, "query16.txt");
    ...
    public void query17(){
        try{
            ...
            writeResultToFile(result, "query17.txt");
